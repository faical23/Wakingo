                ...
                <div class="NouvelleDevisProforma__Header">
                    ...
                    <div class="NouvelleDevisProforma__Header__Right">
                        <div class="RouteLink">
                            ...
                            <span  class="RoutlinkZone">Clients</span>
                        </div>
              ...
              <select name="" id="">
                ...
                <option v-for="(Client,n) in Clients" :key="n"  :value="Client" >{{ Client }}</option>
                   ...
                   <v-row justify="center">
                      ...
                      >
                        <v-card>
                          <v-card-title>
                            <span class="text-h5">Nouveau client rapide </span>
                          </v-card-title>
                          <hr>
                          <v-card-text>
                            ...
                            <div class="f-sec">
                              <div>
                                ...
                                <label for="Code_client">Code du client * :</label>
                              <div>
                                <input v-model="codeClient" placeholder="CLT-68" type="text" name="code_client" >
                              </div>
                              <!-- v-if CLIENT CIVILE -->
                              <div class="clientDiv" v-if="Particulier">
                              ...
                              <!-- v-else ENTREPRISE -->
                              <div class="clientDiv"  v-if="entreprise">
                ...
                <div class="nouveau-bon">
                 <router-link
                    ...
                    <Table :PathPage='PathPage' :NouveauClient='DataNouveauClient'/>
            </div>
          </div>
      </div>
...
<script>
 ...
 props: {
   ninja:{
    ...
    // ParticulierChecked:"false",
    // EntrepriseChecked:"false",
      dialog:false,
      civilite:'',
      codeClient:'',
      NomEntreprise:'',
    ...
    methods: {
      SearchByFunction(){
        ...
        NouveauClient(){
          ...
          if(
            this.codeClient != '' && this.Nom != '' && this.Prenom != '' && this.Famille != 'veuiller selectionner' && this.Email != ''  && this.Telephone != '' 
          ){
            let NouveauClient ={
              Numero:this.codeClient,
              Nom:this.Nom,
            ...
            this.DataNouveauClient = NouveauClient
