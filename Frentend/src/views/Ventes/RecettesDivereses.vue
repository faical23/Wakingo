            ...
            <div class="NouvelleDevisProforma">
                <div class="NouvelleDevisProforma__Header">
                    <div class="NouvelleDevisProforma__Header__Left">
                       <h2>Gestion des recettes diverses</h2>
                    </div>
                    <div class="NouvelleDevisProforma__Header__Right">
                        <div class="RouteLink">
                            ...
                            <span  class="RoutlinkZone">Gestion des recettes diverses</span>
                        </div>
                        <div >
          ...
          <!-- </v-row> -->
                   ...
                   <v-row justify="center">
                      ...
                      >
                        <v-card>
                          <v-card-title>
                            <span class="text-h5">Nouvelle recette diverse <span class="enAttente">En attente</span></span>
                          </v-card-title>
                          <hr>
                          <v-card-text>
                 ...
                 <div class="nouveau-bon">
                        ...
                        <v-btn
                            elevation="1"
                            class="bnt-nv-bon-de-livraison  white--text" @click="dialog = true" 
                            >
                            <v-icon class="mdi-plus-thick">
                                mdi-plus-thick
                            </v-icon>
                                Nouveelle Recette diverse
                            </v-btn>
                    </div>
                    <Table :ElementSearched='ElementSearched' :PathPage='PathPage'  :NouvellRecetteDevis='DataNouvellRecetteDevis' />
            </div>
          </div>
      </div>
    ...
    methods: {
      ...
      if(
        ...
        this.DataNouvellRecetteDevis = NouvellRecetteDevis 
          console.log(NouvellRecetteDevis)
      }
      else{
