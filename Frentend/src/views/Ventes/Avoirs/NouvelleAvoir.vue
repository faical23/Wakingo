            ...
            <div class="NouvelleDevisProforma">
                <div class="NouvelleDevisProforma__Header">
                    <div class="NouvelleDevisProforma__Header__Left">
                        <h2>Avoir : {{Numero}} </h2>
                        <p>Cette page vous permet de créer et mettre à jour un Avoir</p>
                    </div>
                    <div class="NouvelleDevisProforma__Header__Right">
                        <div class="RouteLink">
                            ...
                            <router-link to="/" class="RoutlinkZone">Gestion des Avoir</router-link>>
                            <span  class="RoutlinkZone">Avoir : {{Numero}} </span>
                        </div>
  ...
  export default {
    ...
    methods:{
        ...
        AnnulerInsertData(){
            ...
            history.pushState(null, '', '/Ventes/NouvelleAvoir/Create');  
