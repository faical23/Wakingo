    ...
    <div class="PopupNewClient__information">
        ...
        <div class="EchéancesFactures">
            <div class="FactureAvoirMontant">
                    <h2   style="font-size:15px !important;">Factures : {{Factures}}</h2>
                    <h2   style="font-size:15px !important;">Avoirs :{{Avoirs}} </h2>
                    <h2   style="font-size:15px !important;">Montant à règler : {{MontantRégler}}</h2>
            </div>
            <div class="Table">
                <table>
                    <tr>
