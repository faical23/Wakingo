<template>
    <v-card class="tableDevis" id="tableDevis">
        ...
        <div class="TableAfficheAccomptes">
            <p>Affiche</p>
                        ...
                        <v-col cols="2" class="btnnnn">
                          <v-btn class="action-btn">
                            ...
                            <ul class="dropdown-menu"  outlined aria-labelledby="dropdownMenuButton1">
                                <a class="dropdown-item"  @click="ActionsRows('Valider')">
                                    <i class="fa fa-check"></i>
                                Valider</a>
                                <a class="dropdown-item"  @click="ActionsRows('Annuler')">
                              <i class="fa fa-ban"></i>
                                anunuler</a>
                                <a class="dropdown-item"  @click="ActionsRows('Supprimer')">
                              <v-icon
                                color="blue"
                                size="18"
                                class="action-icon"
